...
public class Home extends NavigationBar {
    ...
    private final By PropertyTexValue = By.id("pptytax");
   ...
   private  static final Logger LOGGER = LogManager.getLogger(Home.class);
    ...
    public Home  enterLoanTerm(String value){
        LOGGER.debug("Enter the LoanTerm value " + value);
    ...
    public Home  enterPropertyTex(String value){
        LOGGER.debug("Enter the Property Tex value " + value);
        ActOn.element(driver, PropertyTexValue).setValue(value);
        return this;
    }
